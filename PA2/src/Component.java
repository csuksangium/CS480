...
public class Component implements Rotatable, Nameable, UpdatingDisplayable,
  ...
  private FloatColor color = FloatColor.BLUE;
  ...
  public String toString(){
	  String xAng = String.valueOf(this.xAngle);
	  String yAng = String.valueOf(this.yAngle);
	  String zAng = String.valueOf(this.zAngle);
